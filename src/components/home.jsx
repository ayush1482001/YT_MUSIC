  ...
  return <>
    ...
    <div className="Home-sub-container">
      ...
      <Grid container sx={{ display: "flex", justifyContent: "center" }} spacing={2}>
        ...
        {data.data && !prop.searchValue ? <Pagination className='pagination' sx={{ display: 'flex', justifyContent: 'center',color:'white', width:'80vw', margin: '50px 0',  }} count={10} page={page} color={'secondary'} onChange={handleChange} /> : null}
      </Grid>
